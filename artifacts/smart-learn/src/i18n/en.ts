export const en = {
  ...
  contact: {
    ...
    serviceOptions: [
      ...
      { value: "mobile-app", label: "Branded Moodle Mobile App" },
    ],
    ...
    sendError: "Failed to send. Please try again or reach out via WhatsApp.",
    tabEmail: "Email Me",
    tabWhatsApp: "WhatsApp",
    waTitle: "Chat on WhatsApp",
    waDesc: "Prefer a quick chat? Send a message directly and I'll reply as soon as possible.",
    waBtn: "Open WhatsApp",
