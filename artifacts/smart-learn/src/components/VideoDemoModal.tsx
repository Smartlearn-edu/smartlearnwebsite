  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 md:p-6 bg-black/85 backdrop-blur-md">
      <motion.div
        ...
        className="relative w-full max-w-5xl rounded-3xl overflow-hidden flex flex-col shadow-2xl border border-purple-500/30"
        style={{
          background:
            "linear-gradient(160deg, rgba(17,10,31,0.98) 0%, rgba(26,14,48,0.95) 50%, rgba(13,8,25,0.99) 100%)",
          minHeight: "620px",
        }}
      >
        {/* Top Header & Chapter Navigation */}
        <div className="p-4 md:px-6 md:py-4 border-b border-white/10 flex flex-wrap items-center justify-between gap-3 bg-white/[0.02]">
          <div className="flex items-center gap-2">
            <span className="w-2.5 h-2.5 rounded-full bg-purple-400 animate-pulse" />
            <span
              className="text-xs md:text-sm font-bold tracking-wider text-purple-300 uppercase"
              style={{ fontFamily: "'Cairo', sans-serif" }}
            >
              {lang === "ar"
                ? "عرض تفاعلي لخبراتي وإضافاتي · 2 دقيقة"
                : "2-MIN INTERACTIVE VIDEO DEMO"}
            </span>
          </div>
        ...
        {/* Chapters Pills */}
        <div className="px-4 py-2.5 border-b border-white/5 bg-black/20 overflow-x-auto flex items-center gap-2 scrollbar-none">
          {CHAPTERS.map((ch, idx) => {
        ...
        {/* Video Stage (Active Scene Renderer) */}
        <div className="relative flex-1 p-6 md:p-10 flex flex-col items-center justify-center overflow-hidden min-h-[380px]">
          ...
          <AnimatePresence mode="wait">
            ...
            {currentChapterIndex === 0 && (
              ...
              >
                {/* Glowing Emblem (No Photo Used!) */}
                <div
                  className="w-24 h-24 md:w-28 md:h-28 rounded-3xl flex items-center justify-center text-4xl md:text-5xl font-black text-white mb-6 shadow-2xl relative"
                  style={{
                    background:
                ...
                >
                  MN
                  <div className="absolute -bottom-2 -right-2 bg-indigo-600 text-white text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider border border-white/20">
                    5+ YRS
                  </div>
                </div>
                ...
                <p
                  className="text-slate-300 text-base md:text-lg max-w-2xl mb-8"
                  style={{ fontFamily: "'Cairo', sans-serif" }}
                >
                  {lang === "ar"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full">
                  ...
                  <div className="p-4 rounded-2xl bg-white/[0.04] border border-white/10 text-center flex flex-col items-center justify-center">
            ...
            {currentChapterIndex === 1 && (
              ...
              >
                <div>
                  ...
                  <p
                    className="text-slate-300 text-sm md:text-base leading-relaxed mb-6"
                    style={{ fontFamily: "'Cairo', sans-serif" }}
                  >
                    {lang === "ar"
                  ...
                  <div className="flex flex-col gap-2">
                    {[
                      lang === "ar"
                        ? "شرح فوري على مستوى كل سؤال"
                        : "Question-level real-time explanations",
                      lang === "ar"
                        ? "توفير التوكن عبر إرسال السياق مرة واحدة فقط"
                        : "Token-saving mode cuts API costs",
                      lang === "ar"
                        ? "برومبتات مخصصة لمعلمي المقررات"
                ...
                <div className="p-6 rounded-2xl bg-white/[0.04] border border-purple-500/30 shadow-xl relative">
                  <div className="flex items-center justify-between text-xs text-slate-400 mb-4 pb-3 border-b border-white/10">
                    <span>
                      {lang === "ar" ? "السؤال 4 · الكيمياء العضوية" : "Question 4 · Organic Chemistry"}
                    </span>
                  ...
                  <div className="p-3 rounded-xl bg-purple-500/15 border border-purple-400/40 text-purple-200 text-xs flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Sparkles size={16} className="text-purple-300 animate-spin" />
                      <span>
                        {lang === "ar"
                          ? "الذكاء الاصطناعي: يرجع ذلك لتكون الروابط الهيدروجينية القوية بين جزيئات الكحول..."
                          : "AI Tutor: Alcohols form strong intermolecular hydrogen bonds..."}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              >
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    {[
                      lang === "ar"
                        ? "تصحيح تلقائي وفق 4 معايير معقدة"
                        : "Grades across structured criteria automatically",
                      lang === "ar"
                        ? "تغذية راجعة فردية ومفصلة لكل معيار"
                ...
                <div className="p-6 rounded-2xl bg-white/[0.04] border border-indigo-500/30 shadow-xl">
                  <div className="flex items-center justify-between mb-4 pb-3 border-b border-white/10">
                    <span className="text-sm font-bold text-white">
                      {lang === "ar" ? "تقرير التقييم الذكي" : "AI Rubric Grade Report"}
                    </span>
            ...
            {currentChapterIndex === 3 && (
              ...
              >
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    {[
                      ...
                      lang === "ar"
                        ? "التسجيل التلقائي الفوري للطالب عند الدفع"
                        : "Instant automatic course enrollment",
                      lang === "ar"
                ...
                <div className="p-6 rounded-2xl bg-white/[0.04] border border-emerald-500/30 shadow-xl">
                  <div className="text-xs text-slate-400 mb-3 uppercase tracking-wider">
                    {lang === "ar" ? "اختر وسيلة الدفع" : "Select Payment Method"}
                  </div>
                  <div className="grid grid-cols-2 gap-3 mb-4">
                    <div className="p-3.5 rounded-xl bg-emerald-500/15 border border-emerald-400/40 text-emerald-200 text-xs font-bold flex items-center gap-2">
                      <CreditCard size={16} />
                      <span>Fawry Pay</span>
                    </div>
                    <div className="p-3.5 rounded-xl bg-white/5 border border-white/10 text-slate-300 text-xs font-bold flex items-center gap-2">
                      <CreditCard size={16} />
                  ...
                  <div className="p-3 rounded-xl bg-emerald-500/20 text-emerald-300 text-center text-xs font-bold">
                    {lang === "ar"
                      ? "✓ تم تأكيد التسجيل الفوري في المقرر"
            ...
            {currentChapterIndex === 4 && (
              ...
              >
                ...
                <div className="p-6 rounded-2xl bg-white/[0.04] border border-amber-500/30 shadow-xl">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-3 rounded-xl bg-amber-500/15 border border-amber-400/30 flex items-center justify-between text-xs">
            ...
            {currentChapterIndex === 5 && (
              ...
              >
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-purple-600/30 to-indigo-600/30 border border-purple-400/40 text-purple-300 text-xs font-bold mb-6">
                  <Zap size={15} />
                  <span>
                    {lang === "ar"
                ...
                <p
                  className="text-slate-300 text-base md:text-lg mb-8 max-w-lg"
                  style={{ fontFamily: "'Cairo', sans-serif" }}
                >
                  {lang === "ar"
                ...
                <div className="flex flex-wrap items-center justify-center gap-4">
                  <a
                    ...
                    className="inline-flex items-center gap-2.5 px-8 py-4 rounded-xl font-bold text-base text-white shadow-xl transition-all hover:scale-105"
                    style={{
                  ...
                  <a
                    href="#contact"
                    onClick={onClose}
                    className="inline-flex items-center gap-2.5 px-8 py-4 rounded-xl font-bold text-base text-white transition-all hover:scale-105"
                    style={{
        ...
        <div className="p-4 md:px-8 md:py-5 border-t border-white/10 bg-black/40 flex flex-col gap-3">
          {/* Progress Timeline Bar */}
          <div
            className="w-full h-2 rounded-full bg-white/10 overflow-hidden cursor-pointer relative group"
            onClick={(e) => {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <button
                ...
                className="w-10 h-10 rounded-full bg-purple-600/30 border border-purple-500/40 text-white flex items-center justify-center hover:bg-purple-600 hover:scale-105 transition-all"
              ...
              <span
                className="text-xs font-mono text-slate-300 ml-1"
