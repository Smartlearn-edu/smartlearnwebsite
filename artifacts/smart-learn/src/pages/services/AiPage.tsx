...
import { Bot, Check, Layers, Globe, Lock, Cpu, MessageCircle } from "lucide-react";
...
const heroData = {
  en: {
    ...
    ctaWaMsg: "Hi! I'd like to discuss AI integration for Moodle.",
  },
  ar: {
    ...
    ctaWaMsg: "مرحباً! أريد مناقشة تكامل الذكاء الاصطناعي مع Moodle.",
  },
};
