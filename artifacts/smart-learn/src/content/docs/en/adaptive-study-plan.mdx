---
title: "Adaptive Study Plan Documentation"
description: "An AI-powered Moodle activity module that generates personalized, adaptive study schedules for students."
---

The **Adaptive Study Plan** (`mod_adaptiveplan`) is a Moodle activity module that uses AI to generate personalized, adaptive study schedules for students based on course content, their prior knowledge, and their available time.
...
## How to Specify Activity Durations (Estimated Time)
